...
public class DuplicateLead {
			...
			public static void main(String[] args) {
				WebDriverManager.chromedriver().setup(); 
				 ...
				 driver.findElement(By.id("createLeadForm_lastName")).sendKeys("kumaresan");
				 driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("pradeep");
				 driver.findElement(By.id("createLeadForm_departmentName")).sendKeys("Testing");
				 driver.findElement(By.id("createLeadForm_description")).sendKeys("Software Testing Team");
				 driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("pradeep@gmail.com");
